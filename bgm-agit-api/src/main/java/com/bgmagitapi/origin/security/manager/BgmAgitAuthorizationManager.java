package com.bgmagitapi.origin.security.manager;

import com.bgmagitapi.origin.service.impl.BgmAgitDynamicAuthorizationServiceImpl;
...
@Service(value = "bgmAgitAuthorizationManager")
public class BgmAgitAuthorizationManager implements AuthorizationManager<RequestAuthorizationContext> {
    
    private static final AuthorizationDecision ACCESS = new AuthorizationDecision(true);
    private  List<RequestMatcherEntry<AuthorizationManager<RequestAuthorizationContext>>> mappings;
    private final HandlerMappingIntrospector introspector;
    private final RoleHierarchyImpl roleHierarchy;
    private final BgmAgitDynamicAuthorizationServiceImpl bgmAgitDynamicAuthorizationServiceImpl;
