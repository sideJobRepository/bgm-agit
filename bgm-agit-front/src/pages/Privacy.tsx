      ...
      <Container>
          ...
          <Section>
              ...
              <List>
                  ...
                  <li>전화번호: 로그인 및 카카오 알림톡 발송</li>
                  <li>이메일 주소: 공지사항 및 서비스 안내, 고객 응대</li>
              </List>
          </Section>
          ...
          <Section>
              ...
              <Text>
                  수집된 개인정보는 회원 탈퇴 또는 서비스 종료 시 즉시 삭제되며, 관계 법령에 따라 일정 기간 보관이 필요한
          ...
          <Section>
              ...
              <Text>
                  이용자는 개인정보 수집 및 이용에 대한 동의를 거부할 수 있으며, 이 경우 회원가입 및 로그인 기능 이용에 제한이 있을 수 있습니다.
              </Text>
          </Section>
      </Container>
