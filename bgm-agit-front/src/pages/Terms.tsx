    ...
    <Container>
      ...
      <Section>
        ...
        <List>
          ...
          <li>룸 이용요금은 1인 기준 평일 9,000원, 주말(토·일) 11,000원입니다.</li>
          <li>일무제한 요금제로, 당일 오전 10시부터 익일 오전 10시까지 이용하실 수 있습니다.</li>
          <li>세트(음료 + 과자) 이용을 원하시면 현장에서 3,000원을 추가 결제합니다.</li>
          <li>
            마작 대탁 대여는 예약금 10,000원 결제 후 잔여 요금을 현장에서 결제하며, 3시간 40,000원,
            5시간 60,000원, 1시간 추가 시 10,000원이 발생합니다.
          </li>
        </List>
      </Section>
